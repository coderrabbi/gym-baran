  ...
  return (
    <Layout>
      <div className="relative">
        <div className="absolute w-[50%] h-full bg-[#D388FF] opacity-40 blur-[282px]"></div>
        <div
          ...
          <div className="flex-1 ">
            <div className="flex flex-col gap-4">
              ...
              <p className={`${styles.paragraph}`}>
                ...
                <br /> fitness will be obtained if you can do regular exercise
                and <br /> run a healthy routine.
              </p>
